...
if (isset($_POST['btn_reg'])) {
    ...
    if (empty($_POST['email'])) {
        ...
        $pattern_email = '/^[A-Za-z0-9_.]{2,32}@([A-Za-z0-9]{2,12})(.[a-zA-Z]{2,12})+/';
    ...
    // Kết luận
    if (empty($error)) {
        $sql = "INSERT INTO `tbl_users` (`fullname`, `username`, `email`, `gender`, `password`)" . "VALUES ('{$fullname}', '{$username}', '{$email}', '{$gender}', '{$password}')";
