...
?>
<?php
#Phải lấy danh danh sách sản phảm đã mua để  đổ lên html
        ...
        ?>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" name="qty[<?php echo $item['id'] ?>]" min="1" max="99" value="<?php echo $item['qty'] ?>" class="num-order">
                                        </td>
                                        <td><?php echo currency_format($item['sub_total']) ?></td>
                                        <td>
                                            <a href="<?php echo $item['url_delete'] ?>" title="Xóa" class="del-product"><i class="fa fa-trash-o"></i></a>
                                        </td>
                                    </tr>
                                <?php
                                } ?>
            ...
            <div class="section" id="action-cart-wp">
                <div class="section-detail">
                    ...
                    <a href="<?php echo $item['url_delete'] ?>" title="" id="delete-cart">Xóa giỏ hàng</a>
                </div>
            </div>
        <?php
        } else {
